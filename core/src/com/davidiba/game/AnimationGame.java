...
//...
	...
	public void create () {
		...
		/*
		frames[0] = new TextureRegion(img,9,190,107,112);
		frames[1] = new TextureRegion(img,124,190,113,107);
		frames[2] = new TextureRegion(img,248,190,101,110);
		frames[3] = new TextureRegion(img,364,190,122,109);*/
	}

	@Override
	public void render () {
		ScreenUtils.clear(1, 0, 0, 1);
		float stateTime = Gdx.graphics.getDeltaTime(); // Accumulate elapsed animation time
